...
| -------------------- | --------------------------------------- | --------------------------------------- |
| Вызов метода         | ссылка на объект                        | ссылка на объект                        |
| вызов вне объекта    | ссылка на глобальный объект             | undefined                               |
| в стрелочной функции | берется из внешней "нормальной функции" | берется из внешней "нормальной функции" |
